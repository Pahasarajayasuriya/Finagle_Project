                 ...
                 <?php else : ?>
                     ...
                     <!-- <div class="user_navbar">
                         <div class="dropdown">
                             ...
                             <button class="dropbtn"><i class="fa fa-user-circle-o" aria-hidden="true"></i>Hi, <?= Auth::getUsername() ?>
                                 <i class="fa fa-caret-down"></i>
                             </button>
                             <div class="dropdown-content">
                                 <a href="<?= ROOT ?>/cus_profile">Profile</a>
             ...
             <div class="separate-category">
                 ...
                 <div class="category">
                     <div class="category-content">
                         <img src="<?= ROOT ?>/assets/images/products/delicious-bread.jpg" alt="breads" class="category-image">
                 ...
                 <div class="category">
                     <div class="category-content">
                         <img src="<?= ROOT ?>/assets/images/products/vegi_roti.jpg" alt="frozen" class="category-image">
                 ...
                 <div class="category">
                     <div class="category-content">
                         <img src="<?= ROOT ?>/assets/images/products/cakes.jpg" alt="cakes" class="category-image">
                     ...
                     <div class="about-us-section">
                         <div class="about-img">
                             ...
                             <div class="img-container-2">
                                 <img class="img-3" src="https://www.finagle.lk/images/site-specific/market-segments/market-segment_supermarket.jpg" alt="">
