...
<body>
    ...
    <div class="home-section">
        ...
        <div class="title-profile">
            ...
            <p class="section-title">MANAGER<span> DETAILS</span></p>
            ...
            <div class="advertisement-header">
                ...
                <div class="header-item" style="margin-left:-8px" >ID</div>
                <div class="header-item" >User Name</div>
                <div class="header-item" style="margin-left:20px">Contact NO</div>
                <div class="header-item" style="margin-left:50px">E-mail</div>
                <div class="header-item" style="margin-left:60px">Joined date</div>
                <div class="header-item" style="margin-left:20px">Branch</div>
                <!-- <div >Address</div>  -->
            </div>
            </div>
            ...
            <div class="popup-container" id="deletePopup">
                <h2>Are you sure you want to remove this manager from the service?</h2>
                <div class="buttons-container">
            ...
            <div class="advertisement-record">
                ...
                <div class="branch-loc"><?= esc($row->username) ?></div>
