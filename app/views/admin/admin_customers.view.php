...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT?>/assets/css/admin/admin_customer.css">
    ...
    <div class="home-section">
        ...
        <div class="title-profile">
            ...
            <div class="advertisement-header">
                ...
                <div class="header-item" style="margin-left:-120px">User Name</div>
            ...
            <div class="popup-container" id="deletePopup">
                <h2>Are you sure you want to delete this customer account?</h2>
                <div class="buttons-container">
