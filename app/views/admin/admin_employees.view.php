...
<body>
    ...
    <div class="home-section">
        ...
        <div class="title-profile">
            ...
            <div class="form-header">
                ...
                <!-- <input class="add-btn" type="button" onclick="openReport()" value="Add Employees"> -->
            </div>
            ...
            <div class="advertisement-header">
                ...
                <div class="header-item id" style ="margin-right:20px">ID</div>
                <div class="header-item name" style="margin-left:-20px">User Name</div>
                <div class="header-item num" style="margin-left:-30px">Contact NO</div>
                <div class="header-item mail" >E-mail</div>
                <div class="header-item date" >Joined date</div>
                <div class="header-item branch" style ="margin-right:160px">Branch</div>
            ...
            <div class="popup-container" id="deletePopup">
                <h2>Are you sure you want to remove this employee from the service?</h2>
                <div class="buttons-container">
            ...
            <div class="advertisement-record">
                ...
                <div class="advertisement-actions">
                  ...
                  <button class="edit-button"><a href="<?= ROOT."/admin_employees/update_employee/".$row->id ?>">Edit</a></button>
    ...
    <script>
        ...
        function confirmDelete(adId) {
            const url = `<?=ROOT."/admin_employees/delete_employee/"?>${adId}`;
            //console.log(url);
